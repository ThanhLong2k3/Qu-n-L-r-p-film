...
const SeatBooking = () => {
  ...
  const handleBooking = () => {
    ...
    const finalPrice = discountAmount > 0 
      ? totalBeforeDiscount * (1 - discountAmount / 100) // Áp dụng giảm giá nếu có
      : totalBeforeDiscount;
  
    // Dữ liệu gửi đi khi tạo booking
    const bookingData = {
      showtime: showtimeId,
      seats: selectedSeats.map(seatId => {
        ...
        return seat ? { seatNumber: seat.id, price: seat.price } : null;
      }).filter(seat => seat !== null),
      foods: [
        { food: "6761fd6e67316cf2e20e2279", quantity: popcornQuantity, price: popcornQuantity * popcornPrice },
        { food: "676966fdac2fea7c284cfffc", quantity: cocaQuantity, price: cocaQuantity * cocaPrice },
      ],
      subtotal: totalBeforeDiscount,  
      discount: discountAmount, // Đảm bảo giá trị discount được truyền vào
      total: finalPrice, // Tổng tiền sau khi giảm giá
    };
    ...
    createBooking(bookingData, {
      onSuccess: (response) => {
        ...
        console.log("Dữ liệu gửi đến API:", bookingData);
